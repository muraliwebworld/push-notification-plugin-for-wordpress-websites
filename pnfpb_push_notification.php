...
if (!defined("PNFPB_PLUGIN_NM")) define("PNFPB_PLUGIN_NM", esc_html(__('Push Notification PNFPB','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_DEVICE_TOKENS_HEADER")) define("PNFPB_PLUGIN_NM_DEVICE_TOKENS_HEADER", esc_html(__('Device tokens','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_SETTINGS")) define("PNFPB_PLUGIN_NM_SETTINGS", esc_html(__('PNFPB - Settings for Push Notification','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_DEVICE_TOKENS")) define("PNFPB_PLUGIN_NM_DEVICE_TOKENS", esc_html(__('PNFPB - Device tokens','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_DEVICE_TOKENS_LIST_HEADER")) define("PNFPB_PLUGIN_NM_DEVICE_TOKENS_LIST_HEADER", esc_html(__('List of device tokens registered for push notification','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_DEVICE_TOKENS_LIST_DETAILS")) define("PNFPB_PLUGIN_NM_DEVICE_TOKENS_LIST_DETAILS", esc_html(__('(Do not delete tokens unneccessarily it will result in user will not receive push notification, unless it is needed, avoid deleting tokens )','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_PWA_HEADER")) define("PNFPB_PLUGIN_NM_PWA_HEADER", esc_html(__('PWA/app','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_PWA_SETTINGS")) define("PNFPB_PLUGIN_NM_PWA_SETTINGS", esc_html(__('PWA Progressive web app settings','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_PWA_SETTINGS")) define("PNFPB_PLUGIN_PWA_SETTINGS", esc_html(__('Below settings are to generate Progressive Web App(PWA) with offline facility','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_PWA_SETTINGS_DESCRIPTION")) define("PNFPB_PLUGIN_PWA_SETTINGS_DESCRIPTION", esc_html(__('All below fields are required to generate Progressive Web App (PWA). Additionally, Enable/disable PWA app by selecting appropriate check box and Enter appropriate URLs to store in cache for offline PWA app, selected pages can be viewed in offline without internet. In offline mode, if page is not available/stored in cache then 404 offline page will be displayed','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_ENABLE_PUSH")) define("PNFPB_PLUGIN_ENABLE_PUSH", esc_html(__('Enable/Disable push notifications for following types','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_SCHEDULE_PUSH")) define("PNFPB_PLUGIN_SCHEDULE_PUSH", esc_html(__('If schedule is enabled then push notification will be sent as per selected schedule otherwise it will be sent whenever new item is posted.<br/>BuddyPress notifications will work only when BuddyPress plugin is installed and active.<br/><b>If you have more than 1000 subscribers, enable schedule in background mode(asynchronous).<br/>Refer scheduled action tab for background scheduled jobs</b><br/>','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_FIREBASE_SETTINGS")) define("PNFPB_PLUGIN_FIREBASE_SETTINGS", esc_html(__('Firebase configuration','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_ONDEMANDPUSH_HEADER")) define("PNFPB_PLUGIN_NM_ONDEMANDPUSH_HEADER", esc_html(__('On demand push notification','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_BUTTON_HEADER")) define("PNFPB_PLUGIN_NM_BUTTON_HEADER", esc_html(__('Customize buttons','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_FRONTEND_SETTINGS_HEADER")) define("PNFPB_PLUGIN_NM_FRONTEND_SETTINGS_HEADER", esc_html(__('Frontend subscription','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_ONDEMANDPUSH_SETTINGS")) define("PNFPB_PLUGIN_NM_ONDEMANDPUSH_SETTINGS", esc_html(__('On demand or one time push notification','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_API_MOBILE_APP_HEADER")) define("PNFPB_PLUGIN_API_MOBILE_APP_HEADER", esc_html(__(" API to integrate mobile app",'push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_ONDEMANDPUSH_DETAIL")) define("PNFPB_PLUGIN_NM_ONDEMANDPUSH_DETAIL", esc_html(__('To send on demand or one time push notification to all subscribers with image','push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NGINX_HEADER")) define("PNFPB_PLUGIN_NGINX_HEADER", esc_html(__("for NGINX",'push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NGINX_SETTINGS")) define("PNFPB_PLUGIN_NGINX_SETTINGS", esc_html(__("Settings for NGINX based server/hosting",'push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_SCHEDULE_ACTIONS")) define("PNFPB_PLUGIN_SCHEDULE_ACTIONS", esc_html(__("Scheduled actions",'push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NGINX_SETTINGS_DESCRIPTION")) define("PNFPB_PLUGIN_NGINX_SETTINGS_DESCRIPTION", esc_html(__("if server/hosting is based on NGINX and if it is not able to serve dynamic service worker push notification js file(like for example: https:/<yourdomain>/pnfpb_icpush_pwa_sw.js), PWA manifest json file (like for example: https:/<yourdomain>/pnfpb_icpush_pwa_sw.js) from APACHE then enable this option to create static service worker js file for push notification and PWA manifest json files in your website root folder. If this option is enabled it will automatically create push notification service worker file which is used for push notification and PWA manifest json file (pnfpbmanifest.json) in root folder",'push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NGINX_SETTINGS_DESCRIPTION2")) define("PNFPB_PLUGIN_NGINX_SETTINGS_DESCRIPTION2", esc_html(__("Enable this option only when push notification dynamic service worker file(like for example: https:/<yourdomain>/pnfpb_icpush_pwa_sw.js) not created for SERVER BASED ON NGINX. If this option is enabled it will automatically create push notification service worker file (pnfpb_icpush_pwa_sw.js) which is used for push notification and PWA manifest json file (pnfpbmanifest.json) in root folder",'push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_DISABLE_SW_SETTINGS_DESCRIPTION")) define("PNFPB_PLUGIN_DISABLE_SW_SETTINGS_DESCRIPTION", esc_html(__("Disable push notification service worker file and PWA",'push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_DISABLE_SW_SETTINGS_DESCRIPTION2")) define("PNFPB_PLUGIN_DISABLE_SW_SETTINGS_DESCRIPTION2", esc_html(__("This option will disable service worker file, it will switch off push notification service as well as it will switch off PWA. Use this option only, if you want to use this plugin for push notification services via REST API (example: for mobile app using WebView) ",'push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_DISABLE_SW_SETTINGS_DESCRIPTION3")) define("PNFPB_PLUGIN_DISABLE_SW_SETTINGS_DESCRIPTION3", esc_html(__("Currently, Service worker file is disabled/not created. if you need push notification and PWA in website, please enable service worker file using below option",'push-notification-for-post-and-buddypress')));
if (!defined("PNFPB_PLUGIN_NM_ACTION_SCHEDULER")) define("PNFPB_PLUGIN_NM_ACTION_SCHEDULER", esc_html(__('Action Scheduler','push-notification-for-post-and-buddypress')));
...
if ( !class_exists( 'PNFPB_ICFM_Push_Notification_Post_BuddyPress' ) ) {
	...
	class PNFPB_ICFM_Push_Notification_Post_BuddyPress
	{
		...
		public function __construct()
		{
			...
			add_action( 'init', array( $this, $this->pre_name .'load_text_domain' ));
			
			add_action( 'admin_init', array( $this, $this->pre_name .'load_text_domain' ));
			...
			add_action( 'wp_enqueue_scripts', array($this, $this->pre_name .'load_translation_scripts'),100 );
      ...
      <p>Important: PNFPB plugin settings are now in top level admin menu. It is in left sidebar of admin menu below settings menu. <a href="'.esc_url(admin_url( "admin.php?page=pnfpb-icfcm-slug" )).'">Click here to go to plugin settings.</a></p></div>';
				}
			...
			if (get_option('pnfpb_ic_fcm_post_schedule_enable') && get_option('pnfpb_ic_fcm_post_schedule_enable') == 1) {
				if ( !wp_next_scheduled( 'PNFPB_cron_post_hook' ) ) {
						if (get_option('pnfpb_ic_fcm_post_timeschedule_enable') === 'hourly') {
							$new_time = strtotime(gmdate("Y-m-d H:i:s", strtotime('+1 hours', strtotime("now"))));
						}
						if (get_option('pnfpb_ic_fcm_post_timeschedule_enable') === 'twicedaily') {
							$new_time = strtotime(gmdate("Y-m-d H:i:s", strtotime('+12 hours', strtotime("now"))));
						}
						if (get_option('pnfpb_ic_fcm_post_timeschedule_enable') === 'daily') {
							$new_time = strtotime(gmdate("Y-m-d H:i:s", strtotime('+24 hours', strtotime("now"))));
						}
						if (get_option('pnfpb_ic_fcm_post_timeschedule_enable') === 'weekly') {
							$new_time = strtotime(gmdate("Y-m-d H:i:s", strtotime('+1 week', strtotime("now"))));
						}					
...
(get_option('pnfpb_ic_fcm_post_timeschedule_enable') == 'weekly' || get_option('pnfpb_ic_fcm_post_timeschedule_enable') == 'twicedaily' || get_option('pnfpb_ic_fcm_post_timeschedule_enable') == 'daily' || get_option('pnfpb_ic_fcm_post_timeschedule_enable') == 'hourly' ||					
					...
					$new_time = strtotime(gmdate("Y-m-d H:i:s", strtotime('+'.$timeseconds.' seconds', strtotime("now"))));
...
(get_option('pnfpb_ic_fcm_buddypresscomments_timeschedule_enable') == 'weekly' || get_option('pnfpb_ic_fcm_buddypresscomments_timeschedule_enable') == 'twicedaily' || get_option('pnfpb_ic_fcm_buddypresscomments_timeschedule_enable') == 'daily' || get_option('pnfpb_ic_fcm_buddypresscomments_timeschedule_enable') == 'hourly' ||					
		...
		*/
		public function PNFPB_add_settings_link( $links, $file ) {
			...
			if ( $file === 'push-notification-for-post-and-buddypress/pnfpb_push_notification.php' && current_user_can( 'manage_options' ) ) {
				...
				$links = (array) $links;
				$links[] = sprintf( '<a href="%s">%s</a>', $url, __( 'Settings', "push-notification-for-post-and-buddypress" ) );
			}
		...
		*/
		public function PNFPB_ic_admin_push_notification_scripts() {
			...
			if ($pwainstallbuttontext === '') {
				$pwainstallbuttontext = esc_html( __( 'Install PWA app', "push-notification-for-post-and-buddypress" ));
			}
			$pwainstallheadertext = get_option("pnfpb_ic_pwa_prompt_header_text");
			if ($pwainstallheadertext === '') {
				$pwainstallheadertext = esc_html( __( 'Install our PWA app', "push-notification-for-post-and-buddypress" ));
			}			
			$pwainstalltext = get_option("pnfpb_ic_pwa_prompt_description");
			if ($pwainstalltext === '') {
				$pwainstalltext =  esc_html(__( 'Install PWA', "push-notification-for-post-and-buddypress" ));
			}			
			...
			wp_enqueue_script( 'pnfpb_ajax_admin_service_account_push', plugins_url( $filename, __FILE__ ), array( 'jquery' ),'2.06.11',true);
			...
			if ($projectId != false && $projectId != '' && $publicKey != false && $publicKey != '' && $apiKey != false && $apiKey != '' && $messagingSenderId != false && $messagingSenderId != '' && get_option( 'pnfpb_ic_disable_serviceworker_pwa_pushnotification' ) != '1')  {
				...
				$unsubscribe_dialog_text_confirm = esc_html( __( 'Your device is unsubscribed from notification', "push-notification-for-post-and-buddypress" ));
					...
					$subscribe_dialog_text_confirm = esc_html( __( 'Subscription updated', "push-notification-for-post-and-buddypress" ));
					...
					$unsubscribe_button_text_shortcode = esc_html( __( 'Unsubscribe push notifications', "push-notification-for-post-and-buddypress" ));
					...
					$subscribe_button_text_shortcode = esc_html( __( 'Subscribe push notifications', "push-notification-for-post-and-buddypress" ));
					...
					$save_button_text = esc_html( __( 'Save', "push-notification-for-post-and-buddypress" ));
					...
					$cancel_button_text = esc_html( __( 'Cancel', "push-notification-for-post-and-buddypress" ));
					...
					$subscribe_button_text = esc_html( __( 'Subscribe push notification', "push-notification-for-post-and-buddypress" ));
					...
					$unsubscribe_button_text = esc_html( __( 'Unsubscribe push notification', "push-notification-for-post-and-buddypress" ));
				...
				$group_unsubscribe_dialog_text_confirm = esc_html( __( 'Your device is unsubscribed from notification', "push-notification-for-post-and-buddypress" ));
					...
					$group_subscribe_dialog_text_confirm = esc_html( __( 'Your device is subscribed from notification', "push-notification-for-post-and-buddypress" ));
					...
					$group_unsubscribe_dialog_text = esc_html( __( 'Would you like to remove push notifications?', "push-notification-for-post-and-buddypress" ));
					...
					$group_subscribe_dialog_text = esc_html( __( 'Would you like to subscribe to push notifications?', "push-notification-for-post-and-buddypress" ));
					...
					$shortcode_close_button_text = esc_html( __( 'Close', "push-notification-for-post-and-buddypress" ));
				...
				$pnfpb_show_custom_post_types = wp_json_encode($pnfpb_show_custom_post_types);	
				
				$pnfpb_show_push_notify_types = wp_json_encode($pnfpb_show_push_notify_types);
				
				$pnfpb_front_end_settings_push_notify_types = wp_json_encode($pnfpb_front_end_settings_push_notify_types);
				
				$pnfpb_progressier_app_option = '';				

				$filename = '/build/pnfpb_push_notification/index.js';
				$ajaxobject = 'pnfpb_ajax_object_push';
				wp_enqueue_script( 'pnfpb-icajax-script-push', plugins_url( $filename, __FILE__ ),array(),'2.06.44',true);
			...
			else 
			{
				if ($pwaappenable === "1" && get_option( 'pnfpb_ic_disable_serviceworker_pwa_pushnotification' ) != '1') {
					...
					$filename = '/build/pnfpb_push_notification/index.js';
					$ajaxobject = 'pnfpb_ajax_object_push';
					wp_enqueue_script( 'pnfpb-icajax-script-push', plugins_url( $filename, __FILE__ ), array( 'jquery' ),'2.06.44',true);
				...
				wp_enqueue_script('pwebtonative_app', plugins_url( $filename, __FILE__ ), array(), '1.0.44', true);
		...
		*/		
		public function PNFPB_load_text_domain() {
			...
			load_plugin_textdomain("push-notification-for-post-and-buddypress", false, dirname(plugin_basename(__FILE__)) . '/languages/');
		...
		*/
		public function PNFPB_ic_push_notification_scripts() {
			...
			wp_enqueue_style( 'pnfpb-icpstyle-es6-name', plugin_dir_url( __FILE__ ).'build/pnfpb_push_notification/index.css',array(),'2.06.51' );
			...
			if (get_option( 'pnfpb_ic_fcm_push_prompt_text' ) && get_option( 'pnfpb_ic_fcm_push_prompt_text' ) != '') {
				...
				$pnfpb_push_prompt_text = esc_html( __("Would you like to subscribe to our notifications?","push-notification-for-post-and-buddypress"));
			}
			...
			if (get_option( 'pnfpb_ic_fcm_push_prompt_confirm_button' ) && get_option( 'pnfpb_ic_fcm_push_prompt_confirm_button' ) != '') {
				...
				$pnfpb_push_prompt_confirm_button_text = esc_html( __("Yes","push-notification-for-post-and-buddypress"));
			}
			...
			if (get_option( 'pnfpb_ic_fcm_push_prompt_cancel_button' ) && get_option( 'pnfpb_ic_fcm_push_prompt_cancel_button' ) != '') {
				...
				$pnfpb_push_prompt_cancel_button_text = esc_html( __("No","push-notification-for-post-and-buddypress"));
			}
			...
			if (get_option( 'pnfpb_ic_fcm_push_prompt_position' ) && get_option( 'pnfpb_ic_fcm_push_prompt_position' ) != '') {
				...
				$pnfpb_push_prompt_position = esc_html( __("pnfpb-top-left","push-notification-for-post-and-buddypress"));
			}
			...
			if (get_option( 'pnfpb_ic_fcm_pwa_prompt_text' ) && get_option( 'pnfpb_ic_fcm_pwa_prompt_text' ) != '') {
				...
				$pnfpb_pwa_prompt_text = esc_html( __("Would you like to install our app?","push-notification-for-post-and-buddypress"));
			}
			...
			if (get_option( 'pnfpb_ic_fcm_pwa_prompt_confirm_button' ) && get_option( 'pnfpb_ic_fcm_pwa_prompt_confirm_button' ) != '') {
				...
				$pnfpb_pwa_prompt_confirm_button_text = esc_html( __("Install","push-notification-for-post-and-buddypress"));
			}
			...
			if (get_option( 'pnfpb_ic_fcm_pwa_prompt_cancel_button' ) && get_option( 'pnfpb_ic_fcm_pwa_prompt_cancel_button' ) != '') {
				...
				$pnfpb_pwa_prompt_cancel_button_text = esc_html( __("Cancel","push-notification-for-post-and-buddypress"));
			}
			...
			if (get_option('pnfpb_progressier_push') && get_option('pnfpb_progressier_push') === '1' && get_option('pnfpb_ic_pwa_app_enable') === '1' && (get_option('pnfpb_ic_pwa_app_custom_prompt_enable') === '1' || get_option('pnfpb_ic_pwa_app_desktop_custom_prompt_enable') === '1' || get_option('pnfpb_ic_pwa_app_mobile_custom_prompt_enable') === '1' || get_option('pnfpb_ic_pwa_app_pixels_custom_prompt_enable') === '1') && get_option( 'pnfpb_ic_disable_serviceworker_pwa_pushnotification' ) != '1') {
				...
				echo '<div class="pnfpb-pwa-dialog-container" id="pnfpb-pwa-dialog-container">
										<div class="pnfpb-pwa-dialog-box" style="background-color:'.esc_html($pnfpb_pwa_prompt_dialog_background).'">
											<div class="pnfpb-pwa-dialog-title" style="color:'.esc_html($pnfpb_pwa_prompt_text_color).';">'.esc_html($pnfpb_pwa_prompt_text).'</div>
											<div class="pnfpb-pwa-dialog-buttons">
												<button id="pnfpb-pwa-dialog-cancel" type="button" class="button secondary" style="color:'.esc_html($pnfpb_pwa_prompt_button_text_color).';background-color:'.esc_html($pnfpb_pwa_prompt_button_background).';">'.esc_html($pnfpb_pwa_prompt_cancel_button_text).'</button>
												<button id="pnfpb-pwa-dialog-subscribe" type="button" class="button primary" style="color:'.esc_html($pnfpb_pwa_prompt_button_text_color).';background-color:'.esc_html($pnfpb_pwa_prompt_button_background).';">'.esc_html($pnfpb_pwa_prompt_confirm_button_text).'</button>
											</div>
										</div>
									</div>';
?>

				<div id="pnfpb-pwa-dialog-ios" class="pnfpb-pwa-dialog-app-installed" title="<?php echo esc_html( __('PWA for IOS browsers',"push-notification-for-post-and-buddypress"));  ?>">
					<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span><?php echo esc_html( __('For IOS and IPAD browsers, Only option to install PWA is to use add to home screen in safari browser',"push-notification-for-post-and-buddypress")); ?></p>
				</div>

				<div id="pnfpb-pwa-dialog-app-installed" class="pnfpb-pwa-dialog-app-installed" title="<?php if ( get_option("pnfpb-pwa-dialog-app-installed_text", false) )  { echo esc_html(get_option("pnfpb-pwa-dialog-app-installed_text")); } else { echo esc_html( __('App installed successfully',"push-notification-for-post-and-buddypress")); } ?>">
									<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span><?php if ( get_option("pnfpb-pwa-dialog-app-installed_description", false)) { echo esc_html(get_option("pnfpb-pwa-dialog-app-installed_description")); } else { echo esc_html( __('Progressive Web App (PWA) is installed successfully.',"push-notification-for-post-and-buddypress")); } ?></p>
				</div>
<?php				
			}				
			...
			$group_unsubscribe_dialog_text = esc_html( __( 'Would you like to unsubscribe push notifications?', "push-notification-for-post-and-buddypress" ));
			...
			if (get_option("pnfpb_onesignal_push") !== '1' && get_option('pnfpb_progressier_push') !== '1') {
            	...
            	wp_enqueue_style( 'pnfpb-icpstyle-name', plugin_dir_url( __FILE__ ).'src/pnfpb_push_notification/css/pnfpb_main.css',array(),'2.04.5' );
				...
				$pwainstallheadertext = get_option("pnfpb_ic_pwa_prompt_header_text");
				if ($pwainstallheadertext === '') {
					$pwainstallheadertext = esc_html( __( 'Install our PWA app with offline functionality', "push-notification-for-post-and-buddypress" ));
				}			
				$pwainstalltext = get_option("pnfpb_ic_pwa_prompt_description");
				if ($pwainstalltext === '') {
					$pwainstalltext = esc_html( __( 'Install PWA', "push-notification-for-post-and-buddypress" ));
				...
				wp_enqueue_script( 'pnfpb-icajax-script-push', plugins_url( $filename, __FILE__ ),array(),'2.06.94',true);
				...
				wp_enqueue_script( 'pnfpb-mobile-app-interface-script', plugins_url( $filename, __FILE__ ),array('jquery','wp-i18n'),'2.06.82',true);				
				
				$ajaxobject = 'pnfpb_ajax_object_mobile_app_interface_script';
				
				wp_localize_script( 'pnfpb-mobile-app-interface-script', $ajaxobject,array( 'ajax_url' => admin_url( 'admin-ajax.php' ), 'userid' => get_current_user_id(), 'pnfpb_show_custom_post_types' => $pnfpb_show_custom_post_types,'pnfpb_show_push_notify_types' => $pnfpb_show_push_notify_types, 'pnfpb_front_end_settings_push_notify_types' => $pnfpb_front_end_settings_push_notify_types) );	
			...
			else 
			{
				if ($pwaappenable === "1" && get_option( 'pnfpb_ic_disable_serviceworker_pwa_pushnotification' ) != '1') {
					...
					wp_enqueue_script( 'pnfpb-icajax-script-push', plugins_url( $filename, __FILE__ ), array( 'jquery' ),'2.06.94',true);
			...
			if (get_option('pnfpb_webtoapp_push') && get_option('pnfpb_webtoapp_push') === '1') {
				...
				wp_enqueue_script('pwebtoapp_app', plugins_url( $filename, __FILE__ ), array(), '1.0.1', true);
		...
		public function PNFPB_include_manifest_link() {
			...
			if (get_option('pnfpb_ic_thirdparty_pwa_app_enable') === '1' && get_option( 'pnfpb_ic_disable_serviceworker_pwa_pushnotification' ) != '1' && get_option( 'pnfpb_ic_pwa_thirdparty_app_id' ) && get_option( 'pnfpb_ic_pwa_thirdparty_app_id' ) != '') {
				...
				echo '<link rel="manifest" href="https://progressier.app/'.esc_html(get_option( 'pnfpb_ic_pwa_thirdparty_app_id')).'/progressier.json">';
				
			} else {
			
				if (get_option('pnfpb_ic_pwa_app_enable') === '1' && get_option( 'pnfpb_ic_disable_serviceworker_pwa_pushnotification' ) != '1') {
				
        			echo '<link rel="manifest" href="'.esc_url(get_home_url()).'/pnfpbmanifest.json">';
					...
					if (get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_640_1136_value') && get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_640_1136_value') !== '') {
						...
						echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_640_1136_value')).'" media="(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)">';
						
					} else {
						
						if (get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )) {

							echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )).'" media="(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)">';							
					...
					if (get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_750_1294_value') && get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_750_1294_value') !== '') {
						...
						echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_750_1294_value')).'" media="(device-width: 375px) and (device-height: 667px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)">';
						
					} else {
						
						if (get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )) {

							echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )).'" media="(device-width: 375px) and (device-height: 667px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)">';						
					...
					if (get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1242_2148_value') && get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1242_2148_value') !== '') {
						...
						echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1242_2148_value')).'" media="(device-width: 414px) and (device-height: 736px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)">';
						
					} else {
						
						if (get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )) {

							echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )).'" media="(device-width: 414px) and (device-height: 736px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)">';						
					...
					if (get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1125_2436_value') && get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1125_2436_value') !== '') {
						...
						echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1125_2436_value')).'" media="(device-width: 375px) and (device-height: 812px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)">';
						
					} else {
						
						if (get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )) {

							echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )).'" media="(device-width: 375px) and (device-height: 812px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)">';						
					...
					if (get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1536_2048_value') && get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1536_2048_value') !== '') {
						...
						echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1536_2048_value')).'" media="(min-device-width: 768px) and (max-device-width: 1024px) and (-webkit-min-device-pixel-ratio: 2) and (orientation: portrait)">';
						
					} else {
						
						if (get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )) {

							echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )).'" media="(min-device-width: 768px) and (max-device-width: 1024px) and (-webkit-min-device-pixel-ratio: 2) and (orientation: portrait)">';						
					...
					if (get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1668_2224_value') && get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1668_2224_value') !== '') {
						...
						echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_1668_2224_value')).'" media="(min-device-width: 834px) and (max-device-width: 834px) and (-webkit-min-device-pixel-ratio: 2) and (orientation: portrait)">';
						
					} else {
						
						if (get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )) {

							echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )).'" media="(min-device-width: 834px) and (max-device-width: 834px) and (-webkit-min-device-pixel-ratio: 2) and (orientation: portrait)">';						
					...
					if (get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_2048_2732_value') && get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_2048_2732_value') !== '') {
						...
						echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option('pnfpb_ic_fcm_pwa_upload_splashscreen_2048_2732_value')).'" media="(min-device-width: 1024px) and (max-device-width: 1024px) and (-webkit-min-device-pixel-ratio: 2) and (orientation: portrait)">';
						
					} else {
						
						if (get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )) {

							echo '<link rel="apple-touch-startup-image" href="'.esc_url(get_option( 'pnfpb_ic_fcm_pwa_upload_icon_512' )).'" media="(min-device-width: 1024px) and (max-device-width: 1024px) and (-webkit-min-device-pixel-ratio: 2) and (orientation: portrait)">';						
		...
		public function PNFPB_custom_pwa_install_prompt() {
			...
			if (get_option('pnfpb_ic_fcm_push_prompt_enable') === '1' && (!get_option('pnfpb_ic_fcm_loggedin_notify') || (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1' && is_user_logged_in()) || (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') !== '1'))) {	
				...
				echo '<button type="button" id="pnfpb-push-subscribe-icon" class="pnfpb-push-subscribe-icon"><img src="'.esc_url($pnfpb_popup_subscribe_icon).'" width="32px" height="32px"/></button>';
				
				$pnfpb_ic_fcm_popup_header_text = esc_html( __('Manage Push Notifications',"push-notification-for-post-and-buddypress"));
				...
				$pnfpb_ic_fcm_custom_prompt_header_text = esc_html( __('We would like to show you notifications for the latest news and updates.',"push-notification-for-post-and-buddypress"));
				...
				$pnfpb_ic_fcm_custom_prompt_allow_button_text = esc_html( __('Allow',"push-notification-for-post-and-buddypress"));
				...
				$pnfpb_ic_fcm_custom_prompt_cancel_button_text = esc_html( __('Cancel',"push-notification-for-post-and-buddypress"));
				...
				$pnfpb_ic_fcm_custom_prompt_close_button_text = esc_html( __('Close',"push-notification-for-post-and-buddypress"));
				...
				$pnfpb_ic_fcm_custom_prompt_header_text_processing = esc_html( __('Please wait...it is processing',"push-notification-for-post-and-buddypress"));
				...
				$pnfpb_ic_fcm_custom_prompt_subscribed_text = esc_html( __('You are subscribed to notifications',"push-notification-for-post-and-buddypress"));
						...
						if (get_option('pnfpb_ic_fcm_show_allposttype_subscriptions_custom_prompt') === '1') {
							...
							$pnfpb_html_subscription_custom_post_options .= 
								'<div class="pnfpb_card">				
									<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable">
											'.esc_html($pnfpb_ic_fcm_bell_subscription_default_label).'
									</label>
									<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
										<input id="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable" class="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable" name="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable" pnfpb_index="'.esc_html($pnfpb_push_count).'" type="checkbox" value="1"> 
							...
							$pnfpb_html_bellicon_subscription_custom_post_options .= 
								'<div class="pnfpb_card">				
									<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable">
											'.esc_html($pnfpb_ic_fcm_bell_subscription_default_label).'
									</label>
									<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
										<input id="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable" class="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable" name="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable" pnfpb_index="'.esc_html($pnfpb_push_count).'" type="checkbox" value="1"> 
										<span class="pnfpb_slider round"></span>
									</label>
								</div>';							
						} 
				...
				if (get_option('pnfpb_ic_fcm_post_enable') === '1') {
						...
						$pnfpb_html_subscription_post_options .= 
							'<div class="pnfpb_card">				
								<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable">
											'.esc_html($pnfpb_bell_icon_subscription_option_post_text).'
								</label>
								<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
									<input id="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable" class="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable" name="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable" pnfpb_index="1" type="checkbox" value="1"> 
									<span class="pnfpb_slider round"></span>
								</label>
							</div>';
						...
						$pnfpb_html_bellicon_subscription_post_options .= 
							'<div class="pnfpb_card">				
								...
								<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
									<input id="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable" class="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable" name="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable"  pnfpb_index="1" type="checkbox" value="1"> 
									<span class="pnfpb_slider round"></span>
								</label>
							</div>';	
				...
				if (get_option('pnfpb_ic_fcm_bactivity_enable') === '1') {
						...
						$pnfpb_html_subscription_activity_options .= 
							'<div class="pnfpb_card">				
								...
								<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
									<input id="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable" class="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable" name="pnfpb_bell_icon_subscription_'.esc_html($post_type).'_enable" pnfpb_index="11" type="checkbox" value="1"> 
									<span class="pnfpb_slider round"></span>
								</label>
							</div>';
						...
						$pnfpb_html_bellicon_subscription_activity_options .= 
							'<div class="pnfpb_card">				
								...
								<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
									<input id="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable" class="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable" name="pnfpb_bell_icon_prompt_subscription_'.esc_html($post_type).'_enable"  pnfpb_index="11" type="checkbox" value="1"> 
									<span class="pnfpb_slider round"></span>
								</label>
							</div>';	
				...
				$pnfpb_html_subscription_options_header = '<div class="pnfpb_bell_icon_subscription_options_container" style="background:'.esc_html($pnfpb_bell_icon_subscription_option_list_background_color).';color:'.esc_html($pnfpb_bell_icon_subscription_option_list_text_color).';">
									<div class="pnfpb_card">				
										<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_bell_icon_subscription_all_enable">
											'.esc_html($pnfpb_bell_icon_subscription_option_all_text).'
										</label>
										<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
				...
				foreach ( $pnfpb_show_push_notify_types as $push_type ) {
					...
					if ($push_type === 'all') {
						...
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("All","push-notification-for-post-and-buddypress"));
													
					}					
					
					if ($push_type === 'activity') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("Activities","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'all_comments') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("Comments in Activity/Post","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'my_comments') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("Comments in My Activity/My Post","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'private_message') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("New private message","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'new_member') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("New member joined","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'friendship_request') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("Friendship request","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'friendship_accepted') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("Friendship accepted","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'avatar_change') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("Avatar change","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'cover_image_change') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("Cover image change","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'group_details_update') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("Group details update","push-notification-for-post-and-buddypress"));
													
					}
												
					if ($push_type === 'group_invite') {
													
						$pnfpb_ic_fcm_front_enable_default_label = esc_html( __("Group Invites","push-notification-for-post-and-buddypress"));
					...
					if ($push_type !== 'all' && $push_type !== 'post' && $push_type !== 'activity' && $push_type !== 'unsubscribe-all' && $push_type !== 'buddypress' && get_option('pnfpb_ic_fcm_'.$pnfpb_show_push_notify_admin_types[$pnfpb_push_admin_type_count].'_enable') === '1') 
					{
						...
						$pnfpb_html_subscription_push_type_options .= 
								'<div class="pnfpb_card">				
									<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_bell_icon_subscription_'.esc_html($push_type).'_enable">
											'.esc_html($pnfpb_ic_fcm_bell_subscription_default_label).'
									</label>
									<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
										<input id="pnfpb_bell_icon_subscription_'.esc_html($push_type).'_enable" class="pnfpb_bell_icon_subscription_'.esc_html($push_type).'_enable" name="pnfpb_bell_icon_subscription_'.esc_html($push_type).'_enable" pnfpb_index="'.esc_html($pnfpb_push_type_index).'" type="checkbox" value="1"> 
										<span class="pnfpb_slider round"></span>
									</label>
								</div>';
				...
				$pnfpb_html_subscription_footer_options = '								
								<button type="button" class="pnfpb-push-subscribe-options-button" id="pnfpb-push-subscribe-options-button" style="background:'.esc_html($pnfpb_bell_icon_subscription_option_update_background_color).';color:'.esc_html($pnfpb_bell_icon_subscription_option_update_text_color).';">
								'.esc_html($pnfpb_bell_icon_subscription_option_update_text).'</button>';
				...
				$pnfpb_html_bellicon_subscription_options_header = '<div class="pnfpb_bell_icon_prompt_subscription_options_container" style="background:'.esc_html($pnfpb_bell_icon_subscription_option_list_background_color).';color:'.esc_html($pnfpb_bell_icon_subscription_option_list_text_color).';">
									<div class="pnfpb_card">				
										<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_bell_icon_subscription_all_enable">
											'.esc_html($pnfpb_bell_icon_subscription_option_all_text).'
										</label>
				...
				foreach ( $pnfpb_show_push_notify_types as $push_type ) {
					...
					if ($push_type !== 'all' && $push_type !== 'post' && $push_type !== 'buddypress'  && $push_type !== 'activity' && $push_type !== 'unsubscribe-all' && get_option('pnfpb_ic_fcm_'.$pnfpb_show_push_notify_admin_types[$pnfpb_push_admin_type_count].'_enable') === '1') {
						...
						$pnfpb_html_bellicon_subscription_push_type_options .= 
							'<div class="pnfpb_card">				
								<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_bell_icon_prompt_subscription_'.esc_html($push_type).'_enable">
											'.esc_html($pnfpb_ic_fcm_bell_subscription_default_label).'
								</label>
								<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
									<input id="pnfpb_bell_icon_prompt_subscription_'.esc_html($push_type).'_enable" class="pnfpb_bell_icon_prompt_subscription_'.esc_html($push_type).'_enable" name="pnfpb_bell_icon_prompt_subscription_'.esc_html($push_type).'_enable" pnfpb_index="'.$pnfpb_push_admin_type_count.'" type="checkbox" value="1"> 
									<span class="pnfpb_slider round"></span>
								</label>
							</div>';
				...
				echo '<div id="pnfpb-push-status-text" class="pnfpb-push-status-text"></div>
						<div id="pnfpb-push-subscribe-button-layout" class="pnfpb-push-subscribe-button-layout">
							<p class="pnfpb-bell-icon-header">'.esc_html($pnfpb_ic_fcm_popup_header_text).'</p>
							...
							<div id="pnfpb-push-subscribe-options-button-container" class="pnfpb-push-subscribe-options-button-container">
								'.wp_kses($pnfpb_html_bellicon_subscription_options,$allowed_html).'							
							</div>					
							<div class="pnfpb-push-msg-container">
								<div class="pnfpb-push-icon"><img src="'.esc_url(get_option('pnfpb_ic_fcm_upload_icon')).'" /></div>
							...
							<div id="pnfpb-push-subscribe-button-container" class="pnfpb-push-subscribe-button-container">
								<button type="button" class="pnfpb-push-subscribe-button" id="pnfpb-push-subscribe-button" style="background:'.esc_attr($pnfpb_ic_fcm_popup_subscribe_button_color).';color:'.esc_html($pnfpb_ic_fcm_popup_subscribe_button_text_color).';">
								</button>
							</div>
						</div>';
				
				echo '<div id="pnfpb-popup-customprompt-container" class="pnfpb-popup-customprompt-container">
						<div id="pnfpb-popup-customprompt-container-dialog-'.esc_html($pnfpb_ic_fcm_custom_prompt_animation).'" class="pnfpb-popup-customprompt-container-dialog-'.esc_html($pnfpb_ic_fcm_custom_prompt_animation).'">
							<div id="pnfpb-popup-customprompt-transistion" class="pnfpb-popup-customprompt-transistion">
								<div class="pnfpb-popup-customprompt-transistion-body" id="pnfpb-popup-customprompt-transistion-body">
									<div class="pnfpb-popup-customprompt-transistion-body-icon">
										<img alt="notification icon" src="'.esc_url($pnfpb_ic_fcm_popup_custom_prompt_subscribe_button_icon).'">
									</div>
									<div class="pnfpb-popup-customprompt-transistion-body-message">'.esc_html($pnfpb_ic_fcm_custom_prompt_header_text).'</div>'.wp_kses($pnfpb_html_subscription_options,$allowed_html).'								
								...
								<div class="pnfpb-popup-customprompt-transistion-footer" id="pnfpb-popup-customprompt-transistion-footer">
									<button class="pnfpb-popup-customprompt-transistion-allow-button" id="pnfpb-popup-customprompt-transistion-allow-button">'.esc_html($pnfpb_ic_fcm_custom_prompt_allow_button_text).'</button>
									<button class="pnfpb-popup-customprompt-transistion-cancel-button" id="pnfpb-popup-customprompt-transistion-cancel-button">'.esc_html($pnfpb_ic_fcm_custom_prompt_cancel_button_text).'</button>
							...
							<div id="pnfpb-popup-customprompt-transistion-confirmation" class="pnfpb-popup-customprompt-transistion-confirmation">
								<div class="pnfpb-popup-customprompt-transistion-body" id="pnfpb-popup-customprompt-transistion-body">
									...
									<div class="pnfpb-popup-customprompt-transistion-body-message">'.esc_html($pnfpb_ic_fcm_custom_prompt_subscribed_text).'</div>
									<div class="clearfix"></div>
									<div id="pnfpb-loading-container"></div>
								</div>
								<div class="pnfpb-popup-customprompt-transistion-footer" id="pnfpb-popup-customprompt-transistion-footer">
									<button class="pnfpb-popup-customprompt-transistion-close-button" id="pnfpb-popup-customprompt-transistion-close-button">'.esc_html($pnfpb_ic_fcm_custom_prompt_close_button_text).'</button>
									<div class="clearfix"></div>
								</div>
							</div>							
						</div>
				...
				echo '<div id="pnfpb-popup-customprompt-vertical-container" class="pnfpb-popup-customprompt-vertical-container">
						<div id="pnfpb-popup-customprompt-vertical-container-dialog-'.esc_html($pnfpb_ic_fcm_custom_prompt_animation).'" class="pnfpb-popup-customprompt-vertical-container-dialog-'.esc_html($pnfpb_ic_fcm_custom_prompt_animation).'">
							<div id="pnfpb-popup-customprompt-vertical-transistion" class="pnfpb-popup-customprompt-vertical-transistion">
								<div class="pnfpb-popup-customprompt-vertical-transistion-body" id="pnfpb-popup-customprompt-vertical-transistion-body">
									...
									<div class="pnfpb-popup-customprompt-vertical-transistion-body-message">'.esc_html($pnfpb_ic_fcm_custom_prompt_header_text).'</div>
								'.wp_kses($pnfpb_html_subscription_options,$allowed_html).'	
									<div class="clearfix"></div>
									<div id="pnfpb-loading-container"></div>
								</div>
								<div class="pnfpb-popup-customprompt-vertical-transistion-footer" id="pnfpb-popup-customprompt-vertical-transistion-footer">
									<button class="pnfpb-popup-customprompt-vertical-transistion-allow-button" id="pnfpb-popup-customprompt-vertical-transistion-allow-button">'.esc_html($pnfpb_ic_fcm_custom_prompt_allow_button_text).'</button>
									<button class="pnfpb-popup-customprompt-vertical-transistion-cancel-button" id="pnfpb-popup-customprompt-vertical-transistion-cancel-button">'.esc_html($pnfpb_ic_fcm_custom_prompt_cancel_button_text).'</button>
									<div class="pnfpb_custom_prompt_loader" id="pnfpb_custom_prompt_loader"></div>
									<div class="clearfix"></div>
								</div>
							</div>
							<div id="pnfpb-popup-customprompt-vertical-transistion-confirmation" class="pnfpb-popup-customprompt-vertical-transistion-confirmation">
								<div class="pnfpb-popup-customprompt-vertical-transistion-body" id="pnfpb-popup-customprompt-vertical-transistion-body">
									...
									<div class="pnfpb-popup-customprompt-vertical-transistion-body-message">'.esc_html($pnfpb_ic_fcm_custom_prompt_subscribed_text).'</div>
									<div class="clearfix"></div>
									<div id="pnfpb-loading-container"></div>
								</div>
								<div class="pnfpb-popup-customprompt-vertical-transistion-footer" id="pnfpb-popup-customprompt-vertical-transistion-footer">
									<button class="pnfpb-popup-customprompt-vertical-transistion-close-button" id="pnfpb-popup-customprompt-vertical-transistion-close-button">'.esc_html($pnfpb_ic_fcm_custom_prompt_close_button_text).'</button>
									<div class="clearfix"></div>
								</div>
							</div>							
						</div>
			...
			echo '<div class="pnfpb-pwa-dialog-container" id="pnfpb-pwa-dialog-container">
						<div class="pnfpb-pwa-dialog-box" style="background-color:'.esc_attr($pnfpb_pwa_prompt_dialog_background).'">
							<div class="pnfpb-pwa-dialog-title" style="color:'.esc_attr($pnfpb_pwa_prompt_text_color).';">'.esc_html($pnfpb_pwa_prompt_text).'</div>
							<div class="pnfpb-pwa-dialog-buttons">
								<button id="pnfpb-pwa-dialog-cancel" type="button" class="button secondary" style="color:'.esc_attr($pnfpb_pwa_prompt_button_text_color).';background-color:'.esc_html($pnfpb_pwa_prompt_button_background).';">'.esc_html($pnfpb_pwa_prompt_cancel_button_text).'</button>
								<button id="pnfpb-pwa-dialog-subscribe" type="button" class="button primary" style="color:'.esc_attr($pnfpb_pwa_prompt_button_text_color).';background-color:'.esc_html($pnfpb_pwa_prompt_button_background).';">'.esc_html($pnfpb_pwa_prompt_confirm_button_text).'</button>
							</div>
						</div>
				</div>';
				...
				if (get_option('pnfpb-pwa-ios-message')) {
					...
					$pnfpb_pwa_ios_message_custom_prompt =  esc_html(__('For IOS and IPAD browsers, Install PWA using add to home screen in ios safari browser or add to dock option in macos safari browser',"push-notification-for-post-and-buddypress"));
			...
			echo '<div class="pnfpb-pwa-dialog-ios-container" id="pnfpb-pwa-dialog-ios-container" style="background-color:'.esc_html($pnfpb_pwa_prompt_dialog_background).'">
						<div class="pnfpb-pwa-dialog-ios-box">
							<div class="pnfpb-pwa-dialog-ios-title pnfpb-notice" style="color:'.esc_html($pnfpb_pwa_prompt_text_color).';"><img class="pnfpb-apple-share-icon" src="'.esc_url(plugin_dir_url( __FILE__ )).'public/img/pnfpb-apple-share-icon-50px.png" alt="PNFPB Install PWA using share icon" width="50px" height="50px"><p>'.esc_html($pnfpb_pwa_ios_message_custom_prompt).'</p><button type="button" id="pnfpb-pwa-dialog-ios-cancel" class="pnfpb-notice-dismiss"><span class="pnfpb-screen-reader-text">Dismiss this notice.</span></button></div>
							<!-- div class="pnfpb-pwa-dialog-ios-buttons">
								<button id="pnfpb-pwa-dialog-ios-cancel" type="button" class="button secondary" style="color:'.esc_html($pnfpb_pwa_prompt_button_text_color).';background-color:'.esc_attr($pnfpb_pwa_prompt_button_background).';">'.esc_html($pnfpb_ic_fcm_custom_prompt_close_button_text).'</button>
							</div -->
						</div>
				</div>';
				
				echo '<div id="pnfpb-pwa-dialog-ios" class="pnfpb-pwa-dialog-app-installed" title="'.esc_html( __('PWA for IOS browsers',"push-notification-for-post-and-buddypress")).'">
					<div class="pnfpb-pwa-dialog-ios-title pnfpb-notice" style="color:'.esc_html($pnfpb_pwa_prompt_text_color).';"><img class="pnfpb-apple-share-icon" src="'.esc_url(plugin_dir_url( __FILE__ )).'public/img/pnfpb-apple-share-icon-50px.png" alt="PNFPB Install PWA using share icon" width="50px" height="50px"><p>'.esc_html($pnfpb_pwa_ios_message_custom_prompt).'</p></div>
				</div>';
...
?>
				...
				<div id="pnfpb-push-notification-blocked" class="pnfpb-push-notification-blocked" title="<?php echo esc_html( __('Push notification permission',"push-notification-for-post-and-buddypress")); ?>">
					<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span><?php echo esc_html( __('Push notification permission blocked in browser settings. Reset the notification settings for website/PWA',"push-notification-for-post-and-buddypress")); ?></p>
				</div>
<?php				
			}
...
<?php				
				...
				if (get_option('pnfpb_progressier_push') !== '1' && get_option('pnfpb_webtoapp_push') !== '1') {
					...
					wp_enqueue_script( 'pnfpb-icajax-onesignal-script-push', plugins_url( $filename, __FILE__ ), array( 'jquery','wp-i18n' ),'2.06.1',true);
		...
		*/
		public function PNFPB_setup_admin_menu()
		{
			...
			add_submenu_page('pnfpb-icfcm-slug', __('Push settings', "push-notification-for-post-and-buddypress"), __('Push settings', "push-notification-for-post-and-buddypress"), 'manage_options', 'pnfpb-icfcm-slug', array($this, 'PNFPB_icfcm_admin_page'),1);
			
			$hook_device_tokens = add_submenu_page('pnfpb-icfcm-slug'            // -> Set to null - will hide menu link
				, __('Device tokens list', "push-notification-for-post-and-buddypress")// -> Page Title
			...
			add_submenu_page('pnfpb-icfcm-slug'            // -> Set to null - will hide menu link
				, __('PWA app settings', "push-notification-for-post-and-buddypress")// -> Page Title
			...
			add_submenu_page('pnfpb-icfcm-slug'            // -> Set to null - will hide menu link
				, __('Send Notification', "push-notification-for-post-and-buddypress")// -> Page Title
		  	...
		  	$hook_notifications_list = add_submenu_page('pnfpb-icfcm-slug'            // -> Set to null - will hide menu link
				, __('Push Notifications list', "push-notification-for-post-and-buddypress")// -> Page Title
			...
			add_submenu_page('pnfpb-icfcm-slug'            // -> Set to null - will hide menu link
				, __('Frontend subscription settings', "push-notification-for-post-and-buddypress")// -> Page Title
			...
			add_submenu_page('pnfpb-icfcm-slug'            // -> Set to null - will hide menu link
				, __('Customize Buttons', "push-notification-for-post-and-buddypress")// -> Page Title
		  	...
		  	add_submenu_page('pnfpb-icfcm-slug'            // -> Set to null - will hide menu link
				, __('Integrate Mobile Apps', "push-notification-for-post-and-buddypress")// -> Page Title
			...
			$hook_pnfpb_action_scheduler = add_submenu_page('pnfpb-icfcm-slug'            // -> Set to null - will hide menu link
				, __('Action scheduler', "push-notification-for-post-and-buddypress")// -> Page Title
																  ...
																  $schedule_post_id=0) 
		{
			...
			if (($apiaccesskey != '' && $apiaccesskey != false) || get_option('pnfpb_httpv1_push') === '1' || get_option( 'pnfpb_onesignal_push' ) === '1' || get_option( 'pnfpb_progressier_push' ) === '1' || get_option( 'pnfpb_webtoapp_push' ) === '1' ) {
				...
				if (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1') {
					...
					$deviceids=$wpdb->get_col($wpdb->prepare("SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE userid > %d AND device_id NOT LIKE %s AND device_id NOT LIKE %s",$table_name,0,'%webview%','%@N%' ));
				
					$deviceidswebview=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE userid > %d AND device_id LIKE %s AND device_id NOT LIKE %s",$table_name,0,'%webview%','%@N%' ));					
			    ...
			    $activity_content_push = wp_strip_all_tags(urldecode(get_option('pnfpb_ic_fcm_ondemand_schedule_pn_content'.$scheduled_day_push_notification)));
				...
				foreach ( $notifications as $notification ){
					...
					$onetime_push_time = gmdate('Y/m/d H:i:s',$notification->scheduled_timestamp);
				...
				if (get_option('pnfpb_webtoapp_push') === '1') {
					...
					$response = $this->PNFPB_icfcm_webtoapp_send_push_notification(0,stripslashes(wp_strip_all_tags($onetime_push_title)),stripslashes(wp_strip_all_tags($onetime_push_content)),$onetime_push_clickurl,$onetime_push_imageurl);
				}
				
				if (get_option('pnfpb_progressier_push') === '1') {
						
					$response = $this->PNFPB_icfcm_progressier_send_push_notification(0,stripslashes(wp_strip_all_tags($onetime_push_title)),stripslashes(wp_strip_all_tags($onetime_push_content)),$onetime_push_clickurl,$onetime_push_imageurl);
					
				} else {				
				
					if (get_option('pnfpb_onesignal_push') === '1') {
						
						$response = $this->PNFPB_icfcm_onesignal_push_notification(0,stripslashes(wp_strip_all_tags($onetime_push_title)),stripslashes(wp_strip_all_tags($onetime_push_content)),$onetime_push_clickurl,$onetime_push_imageurl);
			...
			if ($occurence === 'recurring') {
				...
				try {
					...
					if ( !$future_action_id ) {
    					...
    					$recurring_status = esc_html( __('Finished on ',"push-notification-for-post-and-buddypress")).$datetime->format('Y-m-d H:i:s');
				...
				$onetime_push_update_status = $wpdb->query($wpdb->prepare("UPDATE %i SET scheduled_timestamp = %d,status = %s WHERE id = %d",$table,$current_run_timestamp,$notification_id)) ;
				...
				$datetime->setTimezone(new DateTimeZone(wp_timezone_string()));				
				$recurring_status = esc_html( __('Finished on ',"push-notification-for-post-and-buddypress")).$datetime->format('Y/m/d H:i:s');
				$onetime_push_update_status = $wpdb->query($wpdb->prepare("UPDATE %i SET status = %s WHERE id = %d",$table,$recurring_status,$notification_id));
				if ($schedule_push_type === 'post') {
		...
		*/
		public function PNFPB_icfcm_action_scheduler() {
			?>
				<h1 class="pnfpb_ic_push_settings_header"><?php echo esc_html( __("PNFPB - Action scheduler","push-notification-for-post-and-buddypress"));?></h1>
				<div class="nav-tab-wrapper">
					...
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_action_scheduler&s=pnfpb&action=-1&paged=1&action2=-1" class="nav-tab nav-tab-active tab active"><?php echo esc_html(__("Action Scheduler","push-notification-for-post-and-buddypress"));?></a>
				</div>
				<div class="pnfpb_column_1200">
					<p>
						<?php echo esc_html( __( 'Action Scheduler library is also used by other plugins, like WPForms and WooCommerce, so you might see tasks that are not related to our plugin in the table below.', "push-notification-for-post-and-buddypress" )); ?>
					</p>
					<?php
		...
		*/
		...
		{
		?>
			<h1 class="pnfpb_ic_push_settings_header"><?php echo esc_html( __("PNFPB - Device tokens list","push-notification-for-post-and-buddypress"));?></h1>
			<div class="nav-tab-wrapper">
				<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb-icfcm-slug" class="nav-tab tab"><?php echo esc_html( __("Push Settings","push-notification-for-post-and-buddypress"));?></a>
				<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_device_tokens_list" class="nav-tab nav-tab-active tab active"><?php echo esc_html( __("Device tokens","push-notification-for-post-and-buddypress"));?></a>
				<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_pwa_app_settings" class="nav-tab tab "><?php echo esc_html( __("PWA","push-notification-for-post-and-buddypress"));?></a>
				<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfmtest_notification" class="nav-tab tab "><?php echo esc_html( __("Send push notification","push-notification-for-post-and-buddypress"));?></a>
				<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_onetime_notifications_list&orderby=id&order=desc" class="nav-tab tab"><?php echo esc_html(__("Push Notifications list","push-notification-for-post-and-buddypress"));?></a>
				<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_frontend_settings" class="nav-tab tab"><?php echo esc_html( __("Frontend subscription settings","push-notification-for-post-and-buddypress"));?></a>
				...
				<div class="wrap">
					<div class="pnfpb_row">
  						<div class="pnfpb_column_400">					
							<h2><?php echo esc_html( __("List of device tokens registered for push notification","push-notification-for-post-and-buddypress"));?></h2>
						</div>
					</div>
					<div class="pnfpb_row">
  						<div class="pnfpb_column_400">
							<p>
								<b>
									<?php echo esc_html( __('(Do not delete tokens unneccessarily it will result in user will not receive push notification, unless it is needed, avoid deleting tokens )',"push-notification-for-post-and-buddypress"));?>
								</b>
							</p>
						</div>
					</div>
							...
							<div class="meta-box-sortables ui-sortable">
								<form method="post">
									<?php
										...
										if( isset( $_REQUEST ["s"]) ){
											$this->devicetokens_obj->prepare_items( wp_unslash(sanitize_text_field($_REQUEST ["s"])));
										}
										else 
										{
					...
					<div class="pnfpb_row">
  						<div class="pnfpb_column_400">
							<p>
								<b><?php echo esc_html( __('Subscription option code - details',"push-notification-for-post-and-buddypress"));?> </b><br/>
								<?php echo esc_html( __('if Subscription option is 1000000000000 means user subscribed all notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 1st position indicates - subscribed to all notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 2nd position indicates - subscribed to Post/custom post notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 3rd position indicates - subscribed to Comments notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 4th position indicates - subscribed to my-comments notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 5th position indicates - subscribed to new member notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 6th position indicates - subscribed to private message notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 7th position indicates - subscribed to friendship request notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 8th position indicates - subscribed to friendship accept notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 9th position indicates - Unsubscribed to all notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 10th position indicates - subscribed to profile avatar change notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 11th position indicates - subscribed to profile cover image change notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 12th position indicates - Subscribed to BuddyPress activities/group activities',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 13th position indicates - subscribed to group invite notifications',"push-notification-for-post-and-buddypress"));?> <br/>
								<?php echo esc_html( __(' "1" in 14th position indicates - subscribed to group details update notifications',"push-notification-for-post-and-buddypress"));?> <br/>
							</p>
						</div>
					</div>					
				</div>
		...
		*/
		...
		{    //register our settings
			...
			register_setting("pnfpb_icfcm_group", "pnfpb_ic_fcm_only_post_subscribers_enable");
			register_setting("pnfpb_icfcm_group", "pnfpb_ic_fcm_disable_post_update_enable");
...
(get_option('pnfpb_ic_fcm_buddypresscomments_timeschedule_enable') == 'weekly' || get_option('pnfpb_ic_fcm_buddypresscomments_timeschedule_enable') == 'twicedaily' || get_option('pnfpb_ic_fcm_buddypresscomments_timeschedule_enable') == 'daily' || get_option('pnfpb_ic_fcm_buddypresscomments_timeschedule_enable') == 'hourly' ||					
		...
		*/
				...
				foreach ($super_admins as $adminuser) {
					...
					if( isset($adminuser->ID) && !empty($adminuser->ID) ) {
							...
							if (get_option('pnfpb_ic_fcm_contact_form7_enable') == 1 && get_option('pnfpb_progressier_push') !== '1' && get_option('pnfpb_webtoapp_push') !== '1' && ($apiaccesskey != '' && $apiaccesskey != false) || (get_option('pnfpb_ic_fcm_contact_form7_enable') == 1 && (get_option( 'pnfpb_onesignal_push' ) === '1' || get_option('pnfpb_httpv1_push') === '1'))) {
									...
									$notificationtitle = esc_html( __('New message from contact us page',"push-notification-for-post-and-buddypress"));
									...
									if (get_option('pnfpb_onesignal_push') === '1') {
										...
										if ((get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1') || (get_option('pnfpb_ic_fcm_frontend_enable_subscription') === '1')) {
											...
											$target_userid_array_values=$wpdb->get_col($wpdb->prepare( "SELECT userid FROM %i WHERE device_id LIKE %s AND userid = %d AND (SUBSTRING(subscription_option,1,1) = '1' OR SUBSTRING(subscription_option,5,1) = '1' OR subscription_option = '' OR subscription_option IS NULL) LIMIT 2000",$table_name,'%onesignal%',$adminuser->ID ));
										...
										if (get_option('pnfpb_shortcode_enable') === 'yes' || get_option('pnfpb_ic_fcm_frontend_enable_subscription') === '1') {
											if (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1') {
												$deviceids=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE userid > %d AND device_id NOT LIKE %s AND device_id NOT LIKE %s AND device_id NOT LIKE %s AND userid = %d AND (SUBSTRING(subscription_option,1,1) = '1' OR SUBSTRING(subscription_option,5,1) = '1') LIMIT %d",$table_name,0,'%webview%','%!!%','%@N%',$adminuser->ID,1000  ));												
											} else {
												$deviceids=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM {$table_name} WHERE device_id NOT LIKE '%webview%' AND device_id NOT LIKE '%!!%' AND device_id NOT LIKE '%@N%' AND userid = {$adminuser->ID} AND (SUBSTRING(subscription_option,1,1) = '1' OR SUBSTRING(subscription_option,5,1) = '1') LIMIT %d",$table_name,'%webview%','%!!%','%@N%',$adminuser->ID,1000 ));
											}
										} else {
											if (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1') {
												$deviceids=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE userid > %d AND device_id NOT LIKE %s AND device_id NOT LIKE %s AND device_id NOT LIKE %s AND userid = %d LIMIT %d",$table_name,'%webview%','%!!%','%@N%',$adminuser->ID,1000  ) );				
											} else {
												$deviceids=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE device_id NOT LIKE %s AND device_id NOT LIKE %s AND device_id NOT LIKE %s AND userid = %d LIMIT %d" ,$table_name,'%webview%','%!!%','%@N%',$adminuser->ID,1000 ) );
											}
										}
										...
										$webview = false;
										if (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1') {
											$deviceidswebview=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE userid > %d AND device_id LIKE %s AND device_id NOT LIKE %s AND userid = %d LIMIT %d",$table_name,'%webview%','%!!%','%@N%',$adminuser->ID,1000  ) );											
										} else {
											$deviceidswebview=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE device_id LIKE %s AND device_id NOT LIKE %s AND userid = %d LIMIT 1000",$table_name,'%webview%','%!!%','%@N%',$adminuser->ID,1000   ));
										}
				...
				foreach ($super_admins as $adminuser) {
					...
					if( isset($adminuser->ID) && !empty($adminuser->ID) ) {
						...
						if (get_option('pnfpb_ic_fcm_new_user_registration_enable') == 1 && get_option('pnfpb_progressier_push') !== '1' && get_option('pnfpb_webtoapp_push') !== '1' && ($apiaccesskey != '' && $apiaccesskey != false) || (get_option('pnfpb_ic_fcm_new_user_registration_enable') == 1 && (get_option( 'pnfpb_onesignal_push' ) === '1' || get_option('pnfpb_httpv1_push') === '1'))) {
							...
							$notificationtitle = $new_user_name.esc_html( __(' registered as new member',"push-notification-for-post-and-buddypress"));
							...
							if (get_option('pnfpb_onesignal_push') === '1') {
								...
								$target_userid_array_values=$wpdb->get_col($wpdb->prepare( "SELECT userid FROM %i WHERE device_id LIKE %s AND userid = %d LIMIT %d",$table_name,'%onesignal%',$adminuser->ID,2000 ));
								...
								$response = $this->PNFPB_icfcm_onesignal_push_notification($group_id,$grouptitle,$localactivitycontent,$group_link,$group_image,$target_userid_array);
									...
									if (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1') {
										$deviceids=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE userid > %d AND device_id NOT LIKE %s AND device_id NOT LIKE %s AND device_id NOT LIKE '%@N%' AND userid = {$adminuser->ID} LIMIT 1000",$table_name,0,'%webview%','%!!%','%@N%',$adminuser->ID,1000   ));									
									} else {
										$deviceids=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE device_id NOT LIKE %s AND device_id NOT LIKE %s AND device_id NOT LIKE '%@N%' AND userid = {$adminuser->ID} LIMIT 1000",$table_name,0,'%webview%','%!!%','%@N%',$adminuser->ID,1000   ));
									}
					
					
									$webview = false;
									if (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1') {
										$deviceidswebview=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE userid > 0 AND device_id LIKE %s AND device_id NOT LIKE %s AND userid = %d LIMIT 1000",$table_name,0,'%webview%','%!!%','%@N%',$adminuser->ID,1000   ));										
									} else {
										$deviceidswebview=$wpdb->get_col($wpdb->prepare( "SELECT SUBSTRING_INDEX(device_id, '!!', 1) FROM %i WHERE device_id LIKE %s AND device_id NOT LIKE %s AND userid = %d LIMIT 1000",$table_name,0,'%webview%','%!!%','%@N%',$adminuser->ID,1000  ) );
									}
		...
		public function pnfpb_buddypress_setup_notification_settings_nav() {
			...
			if (!get_option('pnfpb_ic_fcm_loggedin_notify') || (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1' && is_user_logged_in()) || (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') !== '1')) {			
				...
				bp_core_new_subnav_item( array(
					'name'            => _x( 'Push Notification subscription', 'Push Notification subscription sub nav', "push-notification-for-post-and-buddypress" ),
		...
		?>
							...
							<td class="pnfpb_ic_push_settings_table_column column-columnname">
								...
								<div class="pnfpb_row pnfpb_frontend_subscriptions_options_menu_all">
									<?php
										...
										$pnfpb_ic_fcm_front_post_enable_label = esc_html( __("Post","push-notification-for-post-and-buddypress"));
										...
										?>
														...
														<div class="pnfpb_column pnfpb_column_buddypress_functions">
															<div class="pnfpb_card">				
																<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_ic_fcm_front_post_enable"><?php echo esc_html(get_option(('pnfpb_ic_fcm_frontend_settings_post_text'))) ?? esc_html(__("Post","push-notification-for-post-and-buddypress")); ?></label>
																<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
										...
										echo wp_kses($pnfpb_html_frontend_subscription_custom_post_options,$allowed_html);
										...
										foreach ( $pnfpb_show_push_notify_types as $notify_type ) {
											...
											if (get_option('pnfpb_ic_fcm_'.$notify_type.'_enable') === '1') {
												...
												?>	
														<div class="pnfpb_column pnfpb_column_buddypress_functions">
															<div class="pnfpb_card">				
																<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_ic_fcm_front_<?php echo esc_html($notify_type); ?>_enable"><?php echo esc_html($pnfpb_ic_fcm_front_enable_default_label); ?></label>
																<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
																	<input id="pnfpb_ic_fcm_front_<?php echo esc_html($notify_type); ?>_enable" class="pnfpb_ic_fcm_front_<?php echo esc_html($notify_type); ?>_enable" name="pnfpb_ic_fcm_front_<?php echo esc_html($notify_type); ?>_enable" type="checkbox" value="1"> 
																	<span class="pnfpb_slider round"></span>
																</label>
															</div>
														</div>
									...
									<div class="pnfpb_column pnfpb_column_buddypress_functions">
    									<div class="pnfpb_card">
											<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_ic_fcm_group_details_updated_enable">
												<?php if (get_option('pnfpb_ic_fcm_frontend_settings_groupdetails_text')) { echo esc_html(get_option('pnfpb_ic_fcm_frontend_settings_groupdetails_text')); } else { echo esc_html( __("Group details update","push-notification-for-post-and-buddypress")); } ?>
											</label>
											<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
									...
									<div class="pnfpb_column pnfpb_column_buddypress_functions">
    									<div class="pnfpb_card">
											<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_max_width_236" for="pnfpb_ic_fcm_group_invite_enable">
												<?php if (get_option('pnfpb_ic_fcm_frontend_settings_groupinvite_text')) { echo esc_html(get_option('pnfpb_ic_fcm_frontend_settings_groupinvite_text')); } else { echo esc_html( __("Group Invites","push-notification-for-post-and-buddypress")); } ?>
											</label>
											<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_max_width_40">
			...
			<div class="submit">
				<input id="submit" type="button" class="pnfpb_push_notification_frontend_settings_submit primary" name="pnfpb_push_notification_frontend_settings_submit" value="<?php esc_attr(esc_html_e( 'Save Settings', 'push-notification-for-post-and-buddypress' )); ?>" class="auto" />
			</div><br/>
			<?php do_action( 'pnfpb_push_notification_frontend_after_submit' ); ?>
		<?php
			echo wp_kses('<aside class="screen-heading email-settings-screen pnfpb_ic_front_push_notification_settings_messages bp-feedback bp-messages bp-template-notice"><span class="bp-icon" aria-hidden="true"></span><p class="pnfpb_ic_front_push_notification_settings_text">',$allowed_html).esc_html( __("Your notification settings have been saved.","push-notification-for-post-and-buddypress")).wp_kses('</p></aside>',$allowed_html);		
		}		
		...
		*/
		public function PNFPB_pwa_prompt_shortcode() {
			...
			if (get_option('pnfpb-pwa-shortcode-install-icon') && get_option('pnfpb-pwa-shortcode-install-icon') === '1') {
				...
				$pnfpb_pwa_prompt_shortcode = '<div id="pnfpb_pwa_shortcode_box" class="pnfpb_pwa_shortcode_box"><button type="button" id="pnfpb_pwa_button" class="pnfpb_pwa_button" style="color:'.esc_attr($pwa_install_button_text_color).';background-color:'.esc_attr($pwa_install_button_color).';">'.esc_html($pwa_install_button_text).'</button></div>';
	    ...
	    */
	    public function PNFPB_subscribe_push_notification_shortcode() {
			...
			if (!get_option('pnfpb_ic_fcm_loggedin_notify') || (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') === '1' && is_user_logged_in()) || (get_option('pnfpb_ic_fcm_loggedin_notify') && get_option('pnfpb_ic_fcm_loggedin_notify') !== '1')) {
					...
					$unsubscribe_shortcode_dialog_text = esc_html( __('Change push subscriptions',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_shortcode_dialog_text = esc_html( __('Subscribe push notifications',"push-notification-for-post-and-buddypress"));
				
					if (get_option('pnfpb_ic_fcm_subscribe_button_shortcode_text') && get_option('pnfpb_ic_fcm_subscribe_button_shortcode_text') !== false && get_option('pnfpb_ic_fcm_subscribe_button_shortcode_text') !== '') {
						$subscribe_shortcode_dialog_text = get_option('pnfpb_ic_fcm_subscribe_button_shortcode_text');
					}
			
					$subscribe_all_shortcode_dialog_text = esc_html( __('All notifications',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_post_activities_shortcode_dialog_text = esc_html( __('Post',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_activities_shortcode_dialog_text = esc_html( __('Activity',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_all_comments_shortcode_dialog_text = esc_html( __('All Comments',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_mypost_comments_shortcode_dialog_text = esc_html( __('Comments from My Posts/my activities',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_private_message_shortcode_dialog_text = esc_html( __('Private messages',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_new_member_shortcode_dialog_text = esc_html( __('New member joined',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_friendship_request_shortcode_dialog_text = esc_html( __('Friend requests',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_friendship_accepted_shortcode_dialog_text = esc_html( __('Friendship accepted',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_user_avatar_shortcode_dialog_text = esc_html( __('User avatar change',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_cover_image_change_shortcode_dialog_text = esc_html( __('Cover image change',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_group_details_update_shortcode_dialog_text = esc_html( __('Group details update',"push-notification-for-post-and-buddypress"));
					...
					$subscribe_group_invite_shortcode_dialog_text = esc_html( __('Group invite',"push-notification-for-post-and-buddypress"));
					...
					$unsubscribe_all_shortcode_dialog_text = esc_html( __('Un-Subscribe all',"push-notification-for-post-and-buddypress"));
		    ...
		    $pnfpb_notification_shortcode .= '<button type="button" id="pnfpb_unsubscribe_button" class="pnfpb_unsubscribe_button" style="color:'.esc_attr($subscribe_button_text_color).';background-color:'.esc_attr($subscribe_button_color).'">'.esc_html($unsubscribe_shortcode_dialog_text).'</button>';
		    
		    $pnfpb_notification_shortcode .= '<button type="button" id="pnfpb_subscribe_button" class="pnfpb_subscribe_button" style="color:'.esc_attr($subscribe_button_text_color).';background-color:'.esc_attr($subscribe_button_color).'">'.esc_html($subscribe_shortcode_dialog_text).'</button></div>';
		
			$pnfpb_ic_fcm_subscribe_subheading_withtoken_dialog_text = esc_html( __('You are subscribed. Change/Update subscriptions according to your choice.',"push-notification-for-post-and-buddypress"));
			...
			$pnfpb_ic_fcm_subscribe_subheading_notoken_dialog_text = esc_html( __('Please wait...subscribing push notification is in progress.',"push-notification-for-post-and-buddypress"));
			...
			<div id="pnfpb_subscribe_dialog_confirm" class="pnfpb_subscribe_dialog_confirm  ui-helper-clearfix" title="Subscribe notification?">
				<div id="pnfpb_subscribe_dialog_confirm_heading_notoken" class="pnfpb_subscribe_dialog_confirm_heading_notoken">'.esc_html($pnfpb_ic_fcm_subscribe_subheading_notoken_dialog_text).'</div>
				<div id="pnfpb_subscribe_dialog_confirm_heading_token" class="pnfpb_subscribe_dialog_confirm_heading_token">'.esc_html($pnfpb_ic_fcm_subscribe_subheading_withtoken_dialog_text).'</div>				
				<div class="pnfpb_ic_subscription_menu">
					<div class="pnfpb_ic_subscription_input">
					...
					<div class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_all_shortcode_enable">'.esc_html($subscribe_all_shortcode_dialog_text).'</label>
					</div>
				</div>';
			...
			if ($frontend_post_push_enable) {
			 	$pnfpb_notification_shortcode .= '
					<div class="pnfpb_ic_subscription_menu">
						...
						<div class="pnfpb_ic_subscription_checkbox">
							<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_post_activities_shortcode_enable">'.esc_html($subscribe_post_activities_shortcode_dialog_text).'</label>
						</div>
					</div>';
			}
			...
			if (get_option('pnfpb_ic_fcm_bactivity_enable') === '1') {
			 	$pnfpb_notification_shortcode .= '
					<div class="pnfpb_ic_subscription_menu">
						...
						<div class="pnfpb_ic_subscription_checkbox">
							<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_activities_shortcode_enable">'.esc_html($subscribe_activities_shortcode_dialog_text).'</label>
						</div>
					</div>';
			}				
			...
			if (get_option('pnfpb_ic_fcm_bcomment_enable') === '1' && get_option('pnfpb_ic_fcm_buddypress_comments_radio_enable') === '1') {
			 	$pnfpb_notification_shortcode .= '
					<div class="pnfpb_ic_subscription_menu">
						...
						<div class="pnfpb_ic_subscription_checkbox">
							<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_all_comments_shortcode_enable">'.esc_html($subscribe_all_comments_shortcode_dialog_text).'</label>
						</div>
					</div>';
			...
			if (get_option('pnfpb_ic_fcm_bcomment_enable') === '1' && get_option('pnfpb_ic_fcm_buddypress_comments_radio_enable') === '2') {
			 $pnfpb_notification_shortcode .= '
				<div class="pnfpb_ic_subscription_menu">
					...
					<div class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_my_post_shortcode_enable">'.esc_html($subscribe_mypost_comments_shortcode_dialog_text).'</label>
					</div>
				</div>';
			}			
			...
			if (get_option('pnfpb_ic_fcm_bprivatemessage_enable') === '1') {
			 $pnfpb_notification_shortcode .= '
				<div class="pnfpb_ic_subscription_menu">					
					...
					<div class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_private_message_shortcode_enable">'.esc_html($subscribe_private_message_shortcode_dialog_text).'</label>
					</div>
				</div>';
			}
			...
			if (get_option('pnfpb_ic_fcm_new_member_enable') === '1') {
			 $pnfpb_notification_shortcode .= '
				<div class="pnfpb_ic_subscription_menu">					
					...
					<div class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_new_member_shortcode_enable" >'.esc_html($subscribe_new_member_shortcode_dialog_text).'</label>
					</div>
				</div>';
			}
			...
			if (get_option('pnfpb_ic_fcm_friendship_request_enable') === '1') {
			 $pnfpb_notification_shortcode .= '
				<div class="pnfpb_ic_subscription_menu">					
					...
					<div class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_friendship_request_shortcode_enable" >'.esc_html($subscribe_friendship_request_shortcode_dialog_text).'</label>
					</div>
				</div>';
			}
			...
			if (get_option('pnfpb_ic_fcm_friendship_accept_enable') === '1') {
			 $pnfpb_notification_shortcode .= '
				<div class="pnfpb_ic_subscription_menu">					
					...
					<div class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_friendship_accepted_shortcode_enable" >'.esc_html($subscribe_friendship_accepted_shortcode_dialog_text).'</label>
					</div>
				</div>';
			}
			...
			if (get_option('pnfpb_ic_fcm_avatar_change_enable') === '1') {
			 $pnfpb_notification_shortcode .= '
				<div class="pnfpb_ic_subscription_menu">					
					...
					<div  class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_user_avatar_shortcode_enable">'.esc_html($subscribe_user_avatar_shortcode_dialog_text).'</label>
					</div>
				</div>';
			}
			...
			if (get_option('pnfpb_ic_fcm_cover_image_change_enable') === '1') {
			 $pnfpb_notification_shortcode .= '
				<div class="pnfpb_ic_subscription_menu">					
					...
					<div class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_cover_image_change_shortcode_enable" >'.esc_html($subscribe_cover_image_change_shortcode_dialog_text).'</label>
					</div>
				</div>';
			}
			...
			if (get_option('pnfpb_ic_fcm_group_details_updated_enable') === '1') {
			 $pnfpb_notification_shortcode .= '
				<div class="pnfpb_ic_subscription_menu">					
					...
					<div class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_group_details_update_shortcode_enable" >'.esc_html($subscribe_group_details_update_shortcode_dialog_text).'</label>
					</div>
				</div>';
			}
			...
			if (get_option('pnfpb_ic_fcm_group_invitation_enable') === '1') {
			 $pnfpb_notification_shortcode .= '
				<div class="pnfpb_ic_subscription_menu">					
					...
					<div class="pnfpb_ic_subscription_checkbox">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_subscribe_invite_shortcode_enable" >'.esc_html($subscribe_group_invite_shortcode_dialog_text).'</label>
					</div>
				</div>';
			}			
			 ...
			 $pnfpb_notification_shortcode .= '
				...
				<div class="pnfpb_ic_subscription_checkbox"> 
					<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_unsubscribe_all_shortcode_enable">'.esc_html($unsubscribe_all_shortcode_dialog_text).'</label>
				</div>
			</div>
		</div>';
		...
		public function PNFPB_subscribe_to_group_button($grp_btn = array()) {
			...
			if ( is_user_logged_in() && get_option('pnfpb_ic_fcm_buddypress_enable') == 2 ) {
					...
					if(isset($_COOKIE['pnfpb_group_push_notification_'.$group->id])) {
						$cookievalue = wp_unslash(sanitize_text_field($_COOKIE['pnfpb_group_push_notification_'.$group->id]));
					}
					...
					if((strpos(wp_unslash(sanitize_text_field($_SERVER['HTTP_USER_AGENT'])), 'Mobile/') !== false) && (strpos(wp_unslash(sanitize_text_field($_SERVER['HTTP_USER_AGENT'])), 'Safari/') == false)) {
    					$isWebView = true;
					}
					
                    if (strpos(wp_unslash(sanitize_text_field($_SERVER['HTTP_USER_AGENT'])), 'wv') !== false) {
					...
					if ($cookievalue != '' && $isWebView) {					
						...
						$deviceid_select_status = $wpdb->query($wpdb->prepare("SELECT * FROM %i WHERE device_id LIKE %s AND device_id LIKE %s AND userid = %d",$table,'%!!'.$group->id.'%','%webview%'));      
                    }
                    else
                    {
						$deviceid_select_status = $wpdb->query($wpdb->prepare("SELECT * FROM %i WHERE device_id LIKE %s AND userid = %d",$table,'%!!'.$group->id.'!!'.$cookievalue.'%','%webview%'));			             
					}
				
				
					$unsubscribe_button_text = esc_html( __('Unsubscribe push notifications',"push-notification-for-post-and-buddypress"));
				
					if (get_option('pnfpb_ic_fcm_unsubscribe_button_text') && get_option('pnfpb_ic_fcm_unsubscribe_button_text') !== false && get_option('pnfpb_ic_fcm_unsubscribe_button_text') !== '') {
						$unsubscribe_button_text = get_option('pnfpb_ic_fcm_unsubscribe_button_text');
					}
				
					$subscribe_button_text = esc_html( __('Subscribe to push notifications',"push-notification-for-post-and-buddypress"));
		...
		*/
		...
		?>
			...
			<h1 class="pnfpb_ic_push_settings_header"><?php echo esc_html( __("PNFPB - API for Mobile app integration","push-notification-for-post-and-buddypress"));?></h1>
			<div class="nav-tab-wrapper">
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb-icfcm-slug" class="nav-tab tab"><?php echo esc_html( __("Push Settings","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_device_tokens_list" class="nav-tab tab"><?php echo esc_html( __("Device tokens","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_pwa_app_settings" class="nav-tab tab "><?php echo esc_html( __("PWA","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfmtest_notification" class="nav-tab tab "><?php echo esc_html( __("Send push notifications","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_onetime_notifications_list&orderby=id&order=desc" class="nav-tab tab"><?php echo esc_html(__("Push Notifications list","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_frontend_settings" class="nav-tab tab"><?php echo esc_html( __("Frontend subscription settings","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_button_settings" class="nav-tab tab "><?php echo esc_html(__("Customize buttons","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_integrate_app" class="nav-tab nav-tab-active tab active"><?php echo esc_html(__("Integrate Mobile app","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_settings_for_ngnix_server" class="nav-tab tab "><?php echo esc_html(__("NGINX","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_action_scheduler&s=pnfpb&action=-1&paged=1&action2=-1" class="nav-tab tab "><?php echo esc_html(__("Action Scheduler","push-notification-for-post-and-buddypress"));?></a>
			</div>
			<div class="pnfpb_column_1200">
			<h2 class="pnfpb_ic_push_settings_header2"><?php echo esc_html( __('Generate secret key for Android/Ios app integration',"push-notification-for-post-and-buddypress"));?></h2>
			<h4 class="pnfpb_ic_push_settings_header2"><?php echo esc_html( __('This secret key will be used to get subscription token in secured manner from Android/Ios app to store it in WordPress Database table to send push notifications for app users',"push-notification-for-post-and-buddypress"));?></h4>
			<h4 class="pnfpb_ic_push_settings_header2"><?php echo esc_html( __('Use this secret key in http post request using this rest api from app',"push-notification-for-post-and-buddypress"));?></h4>
    				...
    				<tbody>
    					<tr  class="pnfpb_ic_push_settings_table_row">
							<td class="pnfpb_ic_push_settings_table_label_column column-columnname">
								<div><?php submit_button(__( 'Generate/Change secret key', "push-notification-for-post-and-buddypress" ), 'primary' ); ?></div>
								<label><?php echo esc_html(get_option('PNFPB_icfcm_integrate_app_secret_code'));?></label>
							</td>							
    					</tr>						
					</tbody>
				</table>
...
https://domainname.com/wp-json/PNFPBpush/v1/subscriptiontoken</h4>
			...
			<div id="pnfpb-admin-right_sidebar">
				<h4><?php echo esc_html( __("Mobile app integration help on github respository","push-notification-for-post-and-buddypress"));?></h4>
				<ol>
					<li><a href="https://github.com/muraliwebworld/android-app-to-integrate-push-notification-wordpress-plugin" target="_blank"><?php echo esc_html( __("Procedure/Sample code to Integrate Android mobile app with this plugin using API","push-notification-for-post-and-buddypress"));?></a></li>
					<li><a href="https://github.com/muraliwebworld/ios-swift-app-to-integrate-push-notification-wordpress-plugin" target="_blank"><?php echo esc_html( __("Procedure/Sample code to Integrate IOS mobile app with this plugin using API","push-notification-for-post-and-buddypress"));?></a></li>
				</ol>
			</div>
			<br /><br />			
			<div><h2 class="pnfpb_ic_push_settings_header"><?php echo esc_html( __("Disable push notification service worker file and PWA","push-notification-for-post-and-buddypress"));?></h2></div>
			<?php if (get_option( 'pnfpb_ic_disable_serviceworker_pwa_pushnotification' ) === '1') { ?>
				<p class="pnfpb_ic_red_color_text"><b><?php echo esc_html( __("Currently, Service worker file is disabled/not created. if you need push notification and PWA in website, please enable service worker file using below option","push-notification-for-post-and-buddypress"));?></b></p>
			<?php } ?>
			<form method="post" enctype="multipart/form-data" class="form-field">
				<table class="pnfpb_ic_push_settings_table widefat fixed">
    				<tbody>
    					<tr  class="pnfpb_ic_push_settings_table_row">
							<td class="column-columnname">
								<?php if (get_option( 'pnfpb_ic_disable_serviceworker_pwa_pushnotification' ) === '1') { ?> 
								<div class="col-sm-10"><?php submit_button(__( 'Enable service worker file', "push-notification-for-post-and-buddypress" ), 'primary','disable_sw_file' ); ?></div>
								<?php } else { ?>
								<div class="col-sm-10"><?php submit_button(__( 'Disable service worker file', "push-notification-for-post-and-buddypress" ), 'primary','disable_sw_file' ); ?></div>		
								<?php } ?>
								<ul>
									<li><?php echo esc_html( __("This option will disable service worker file, it will switch off push notification service as well as it will switch off PWA. Use this option only, if you want to use this plugin for push notification services via REST API (example: for mobile app using WebView)","push-notification-for-post-and-buddypress"));?></li>
								</ul>
							</td>							
    					</tr>							
					</tbody>
		...
		*/		
		public function PNFPB_icfcm_settings_for_ngnix_server() {
			...
			<h1 class="pnfpb_ic_push_settings_header"><?php echo esc_html( __("PNFPB - settings for NGNIX server","push-notification-for-post-and-buddypress"));?></h1>
			<div class="nav-tab-wrapper">
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb-icfcm-slug" class="nav-tab tab"><?php echo esc_html( __("Push Settings","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_device_tokens_list" class="nav-tab tab"><?php echo esc_html( __("Device tokens","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_pwa_app_settings" class="nav-tab tab "><?php echo esc_html( __("PWA","push-notification-for-post-and-buddypress"));?></a>
					...
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_button_settings" class="nav-tab tab "><?php echo esc_html(__("Customize buttons","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_integrate_app" class="nav-tab tab "><?php echo esc_html(__("Integrate Mobile app","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_settings_for_ngnix_server" class="nav-tab nav-tab-active tab active"><?php echo esc_html(__("NGINX","push-notification-for-post-and-buddypress"));?></a>
					<a href="<?php echo esc_url(admin_url());?>admin.php?page=pnfpb_icfm_action_scheduler&s=pnfpb&action=-1&paged=1&action2=-1" class="nav-tab tab "><?php echo esc_html(__("Action Scheduler","push-notification-for-post-and-buddypress"));?></a>
			</div>
			<div class="pnfpb_column_1200">	
				<h1 class="pnfpb_ic_push_settings_header"><?php echo esc_html( __("Settings for NGINX based server/hosting","push-notification-for-post-and-buddypress"));?></h1>
  										...
  										<div class="pnfpb_column_400">
    										<div class="pnfpb_card">									
												<label for="pnfpb_ic_nginx_static_files_enable">
													<?php echo esc_html( __("Enable/Disable static service worker and PWA manifest files","push-notification-for-post-and-buddypress"));?>
												</label>
    						...
    						<tr  class="pnfpb_ic_push_settings_table_row">
								<td class="column-columnname">
									...
									<ul>
										...
										<li><?php echo esc_html( __("If Push notification admin settings or PWA admin settings are changed then regenerate service worker file by switching off this option, save changes, switch on again and save the changes again, so that service worker file and PWA manifest files will be regenerated","push-notification-for-post-and-buddypress"));?></li>
	...
	include(plugin_dir_path(__FILE__) . 'public/pnfpb_topic_subscription_update/PNFPB_httpv1_subscription_option_update.php');
