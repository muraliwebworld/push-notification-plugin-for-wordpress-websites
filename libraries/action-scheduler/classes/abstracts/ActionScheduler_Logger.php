...
abstract class ActionScheduler_Logger {
	...
	public function log_started_action( $action_id, $context = '' ) {
		if ( ! empty( $context ) ) {
			...
			$message = __( 'action started', 'push-notification-for-post-and-buddypress' );
		}
	...
	public function log_completed_action( $action_id, $action = null, $context = '' ) {
		if ( ! empty( $context ) ) {
			...
			$message = __( 'action complete', 'push-notification-for-post-and-buddypress' );
		}
		$this->log( $action_id, $message );
	}
	...
	public function log_ignored_action( $action_id, $context = '' ) {
		if ( ! empty( $context ) ) {
			...
			$message = __( 'action ignored', 'push-notification-for-post-and-buddypress' );
		}
		$this->log( $action_id, $message );
	}
	...
	public function log_failed_fetch_action( $action_id, ?Exception $exception = null ) {
		...
		if ( ! is_null( $exception ) ) {
			...
			$log_message = __( 'There was a failure fetching this action', 'push-notification-for-post-and-buddypress' );
		}
