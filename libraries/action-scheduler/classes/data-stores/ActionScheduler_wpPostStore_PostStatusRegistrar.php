...
class ActionScheduler_wpPostStore_PostStatusRegistrar {
	...
	protected function post_status_failed_labels() {
		$labels = array(
			'label'       => _x( 'Failed', 'post', 'push-notification-for-post-and-buddypress' ),
			/* translators: %s: count */
			'label_count' => _n_noop( 'Failed <span class="count">(%s)</span>', 'Failed <span class="count">(%s)</span>', 'push-notification-for-post-and-buddypress' ),
		);
	...
	protected function post_status_running_labels() {
		$labels = array(
			'label'       => _x( 'In-Progress', 'post', 'push-notification-for-post-and-buddypress' ),
			/* translators: %s: count */
			'label_count' => _n_noop( 'In-Progress <span class="count">(%s)</span>', 'In-Progress <span class="count">(%s)</span>', 'push-notification-for-post-and-buddypress' ),
		);
