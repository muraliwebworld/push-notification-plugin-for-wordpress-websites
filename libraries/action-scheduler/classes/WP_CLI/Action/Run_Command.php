	...
	public function execute() {
		...
		$progress_bar = \WP_CLI\Utils\make_progress_bar(
			sprintf(
				...
				_n( 'Executing %d action', 'Executing %d actions', $this->action_counts['total'], 'push-notification-for-post-and-buddypress' ),
		...
		foreach ( array(
			 ...
			 */
			$format = _n( '%1$d action %2$s.', '%1$d actions %2$s.', $count, 'push-notification-for-post-and-buddypress' );
		...
		\WP_CLI::success(
			sprintf(
				...
				_n( 'Executed %d action.', 'Executed %d actions.', $this->action_counts['executed'], 'push-notification-for-post-and-buddypress' ),
