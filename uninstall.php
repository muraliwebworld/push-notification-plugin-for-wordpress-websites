...
delete_option("pnfpb_ai_assistant_enable");
delete_option("pnfpb_ai_assistant_enable_on_demand");
delete_option("pnfpb_ai_assistant_enable_post_editor");
delete_option("pnfpb_ai_assistant_provider");
delete_option("pnfpb_ai_assistant_endpoint");
delete_option("pnfpb_ai_assistant_api_key");
delete_option("pnfpb_ai_assistant_model");
delete_option("pnfpb_ai_assistant_max_input_chars");
delete_option("pnfpb_ai_assistant_share_full_content");
delete_option("pnfpb_ai_assistant_enable_send_time");
delete_option("pnfpb_ai_assistant_enable_audience");
