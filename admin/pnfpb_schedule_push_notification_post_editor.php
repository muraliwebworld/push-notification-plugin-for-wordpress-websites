      		...
      		<fieldset id="pnfpb_push_notification_send_layout">
				...
				<br/><br/>
  				<div class="pnfpb_column_400 pnfpb_schedule_push_notification_post_editor">
						...
						<br/><br/>
        				<label>
          						<input type="checkbox" id="pnfpb_push_notification_schedule_checkbox" name="pnfpb_push_notification_schedule_checkbox" value="1" <?php checked( '1', get_post_meta( $post->ID, 'pnfpb_push_notification_schedule_checkbox', true ) ); ?> />
							<?php
