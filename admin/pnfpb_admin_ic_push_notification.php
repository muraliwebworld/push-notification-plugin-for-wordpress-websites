...
<h2 class="nav-tab-wrapper"><a href="options-general.php?page=pnfpb-icfcm-slug" class="nav-tab nav-tab-active">Settings</a><a href="options-general.php?page=pnfpb_icfm_device_tokens_list" class="nav-tab"><?php echo __(PNFPB_PLUGIN_NM_DEVICE_TOKENS_HEADER);?></a></h2>
...
<table class="pnfpb_ic_push_settings_table widefat fixed">
    ...
    <tr  class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_google_api"><?php echo __("Firebase Server Key",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname"><input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_fcm_google_api" name="pnfpb_ic_fcm_google_api" type="text" value="<?php echo get_option( 'pnfpb_ic_fcm_google_api' ); ?>" required="required" /></td>
    </tr>
        
    <tr  class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_api"><?php echo __("Firebase API Key",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname"><input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_fcm_api" name="pnfpb_ic_fcm_api" type="text" value="<?php echo get_option( 'pnfpb_ic_fcm_api' ); ?>" required="required" /></td>
    </tr>
		
	   <tr class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_authdomain"><?php echo __("Firebase Auth domain",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname"><input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_fcm_authdomain" name="pnfpb_ic_fcm_authdomain" type="text" value="<?php echo get_option( 'pnfpb_ic_fcm_authdomain' ); ?>" required="required" /></td>
    </tr>
		
	   <tr class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_databaseurl"><?php echo __("Firebase Database url",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname"><input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_fcm_databaseurl" name="pnfpb_ic_fcm_databaseurl" type="text" value="<?php echo get_option( 'pnfpb_ic_fcm_databaseurl' ); ?>" required="required" /></td>
    </tr>
		
	   <tr class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_projectid"><?php echo __("Firebase Project id",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname"><input class="pnfpb_ic_push_settings_table_value_column_input_field"  id="pnfpb_ic_fcm_projectid" name="pnfpb_ic_fcm_projectid" type="text" value="<?php echo get_option( 'pnfpb_ic_fcm_projectid' ); ?>" required="required" /></td>
    </tr>

	<tr class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_storagebucket"><?php echo __("Firebase Storage Bucket",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname"><input class="pnfpb_ic_push_settings_table_value_column_input_field"  id="pnfpb_ic_fcm_storagebucket" name="pnfpb_ic_fcm_storagebucket" type="text" value="<?php echo get_option( 'pnfpb_ic_fcm_storagebucket' ); ?>" required="required" /></td>
    </tr>
		
	<tr class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_messagingsenderid"><?php echo __("Firebase Messaging Sender id",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname"><input class="pnfpb_ic_push_settings_table_value_column_input_field"  id="pnfpb_ic_fcm_messagingsenderid" name="pnfpb_ic_fcm_messagingsenderid" type="text" value="<?php echo get_option( 'pnfpb_ic_fcm_messagingsenderid' ); ?>" required="required" /></td>
    </tr>

	<tr class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_appid"><?php echo __("Firebase App id",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname"><input class="pnfpb_ic_push_settings_table_value_column_input_field"   id="pnfpb_ic_fcm_appid" name="pnfpb_ic_fcm_appid" type="text" value="<?php echo get_option( 'pnfpb_ic_fcm_appid' ); ?>" required="required" /></td>
    </tr>


	<tr class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_publickey"><?php echo __("Firebase Public key",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname"><input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_fcm_publickey" name="pnfpb_ic_fcm_publickey" type="text" value="<?php echo get_option( 'pnfpb_ic_fcm_publickey' ); ?>" required="required" /></td>
    </tr>
    <tr class="pnfpb_ic_push_settings_table_row">
        <td class="pnfpb_ic_push_settings_table_label_column column-columnname"><label for="pnfpb_ic_fcm_upload_icon"><?php echo __("FCM Push Icon(16x16 pixels)",PNFPB_TD);?></label> </td>
        <td class="pnfpb_ic_push_settings_table_value_column column-columnname">
            <table><tr>
