					...
					<div class="pnfpb_column_400">
						<div class="pnfpb_card">
							<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_container  pnfpb_padding_top_8">
								<?php echo __("New BuddyPress activity",'PNFPB_TD');?>
							...
							<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_container  pnfpb_padding_top_8">
								<?php echo __("New BuddyPress group activity (only for group members)",'PNFPB_TD');?>
							...
							<button type="button" class="pnfpb_activity_form_button" onclick="toggle_activity_content_form()">Customize</button>
						</div>
					</div>
				</div>
				<div class="pnfpb_row">
				...
				<div class="pnfpb_row">
					<div class="pnfpb_column_400">
    					<div class="pnfpb_card">
							...
							<button type="button" class="pnfpb_comments_content_button" onclick="toggle_comments_content_form()">Customize</button>
						</div>
					</div>
				</div>
				<div class="pnfpb_row">
				...
				<div class="pnfpb_row">
					<div class="pnfpb_column_400 pnfpb_column_buddypress_functions">
    					<div class="pnfpb_card">
							...
							<button type="button" class="pnfpb_private_message_button pnfpb_flex_grow_3" onclick="toggle_private_message_form()">Customize</button>
						</div>
					</div>
					...
					<br/><p>[sender name] is the shortcode which replaces with sender name and modify remaining text according to your choice</p><br/>
					...
					<div class="pnfpb_column_400 pnfpb_column_buddypress_functions">
    					<div class="pnfpb_card">
							...
							<button type="button" class="pnfpb_new_member_button pnfpb_flex_grow_3" onclick="toggle_new_member_form()">Customize</button>	
						</div>
					</div>
					<div class="pnfpb_ic_new_member_form pnfpb_column_400">
						...
						<br/><p>[member name] is the shortcode which replaces with sender name and modify remaining text according to your choice</p><br/>
				...
				<div class="pnfpb_row">
					<div class="pnfpb_column_400 pnfpb_column_buddypress_functions">
    					<div class="pnfpb_card">
							...
							<button type="button" class="pnfpb_friendship_request_button pnfpb_flex_grow_3" onclick="toggle_friendship_request_form()">Customize</button>
						</div>
					</div>
					...
					<div class="pnfpb_column_400 pnfpb_column_buddypress_functions">
    					<div class="pnfpb_card">
							...
							<button type="button" class="pnfpb_friendship_accept_button pnfpb_flex_grow_3" onclick="toggle_friendship_accept_form()">Customize</button>
						</div>
					</div>
					<div class="pnfpb_ic_friendship_accept_form pnfpb_column_400">
						...
						<input  class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_fcm_friendship_accept_text" name="pnfpb_ic_fcm_friendship_accept_text" type="text" value="<?php if(get_option( 'pnfpb_ic_fcm_friendship_accept_text' )) {echo get_option( 'pnfpb_ic_fcm_friendship_accept_text' );} else { echo '[friendship acceptor name] accepted your friendship request';} ?>"  />
						<br/><p>[friendship acceptor name] is the shortcode which replaces with sender name and modify remaining text according to your choice</p><br/>
				...
				<div class="pnfpb_row">
					<div class="pnfpb_column_400 pnfpb_column_buddypress_functions">
    					<div class="pnfpb_card">
							...
							<button type="button" class="pnfpb_avatar_change_button pnfpb_flex_grow_3" onclick="toggle_avatar_change_form()">Customize</button>
						</div>
					</div>
					<div class="pnfpb_ic_avatar_change_form pnfpb_column_400">
						...
						<input  class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_fcm_avatar_change_text" name="pnfpb_ic_fcm_avatar_change_text" type="text" value="<?php if(get_option( 'pnfpb_ic_fcm_avatar_change_text' )) {echo get_option( 'pnfpb_ic_fcm_avatar_change_text' );} else { echo '[member name] updated avatar';} ?>"  />
						<br/><p>[member name] is the shortcode which replaces with sender name and modify remaining text according to your choice</p><br/>
					...
					<div class="pnfpb_ic_cover_image_change_form pnfpb_column_400">
						...
						<input  class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_fcm_cover_image_change_text" name="pnfpb_ic_fcm_cover_image_change_text" type="text" value="<?php if(get_option( 'pnfpb_ic_fcm_cover_image_change_text' )) {echo get_option( 'pnfpb_ic_fcm_cover_image_change_text' );} else { echo '[member name] updated cover photo';} ?>"  />
						<br/><p>[member name] is the shortcode which replaces with sender name and modify remaining text according to your choice</p><br/>
...
<div class="pnfpb_column_full">
	<button type="button" class="pnfpb_ic_firebase_configuration_help_button" onclick="toggle_firebase_configuration_help()">Tutorial on Firebase</button>
</div>
...
<div class="pnfpb_column_full">
	<button type="button" class="pnfpb_ic_firebase_configuration_button" onclick="toggle_firebase_configuration()">Hide Firebase configuration</button>
</div>
