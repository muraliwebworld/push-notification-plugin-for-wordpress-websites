...
if (
    ...
    if (
        ...
        if ($action_scheduler_status) {
            $pnfpb_admin_message =
                ...
                '<a href="' .
                admin_url() .
                'admin.php?page=pnfpb_icfm_onetime_notifications_list&orderby=id&order=desc">' .
                esc_html(
                    __(
                        "Refer notification list tab on id ",
                        "push-notification-for-post-and-buddypress"
                    )
                ) .
                $insertid .
                ...
                esc_html(
                    __(
                        "<br/>Scheduled timestamp reference number is ",
                        "push-notification-for-post-and-buddypress"
                    )
                ) .
                $scheduled_day_push_notification .
    ...
    if (
        ...
        if (
            ...
            ((!isset($screen) || !isset($screen->base)) &&
                ...
                if ($post->post_status == "publish") {
                    ...
                    if (
                        (isset($screen) &&
                            $screen->base == "post" &&
                            isset(
                                $_POST["pnfpb_push_notification_send_checkbox"]
                            ) &&
                            $_POST["pnfpb_push_notification_send_checkbox"] ===
                                "1") ||
                        (isset($screen) &&
